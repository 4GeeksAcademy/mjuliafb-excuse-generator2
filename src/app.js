...
const generateExcuse = () => {
  ...
  const whoIndex = getRandomIndex(whoArray);
  const actionIndex = getRandomIndex(actionArray);
  const whatIndex = getRandomIndex(whatArray);
  const whenIndex = getRandomIndex(whenArray);
